...
then we use an indexing convetion under which for any refenece $\rho\in\mathcal{P}(p)$, a quadruple $(\rho, m_\rho, s_\rho, \phi_\rho)$ is a corresponding sub proof step.
