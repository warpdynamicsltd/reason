...
\item Language is enriched by additional set of consts $c_d$ for $d=0, 1, \dots$ and by additional set of consts 
...
The letters $A, B, R, T$ stands for $Assumption, Block, Rule, Tautology$.
...
$s$ = $[(r, m_r, s_r, \phi_r)]_{i=1}^k$ such that
